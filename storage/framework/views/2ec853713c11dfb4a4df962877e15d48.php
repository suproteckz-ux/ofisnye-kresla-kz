...
<footer style="background:#111;color:#aaa;margin-top:auto">
    <div style="max-width:1280px;margin:0 auto;padding:40px 24px 20px">
        <div class="footer-cols" style="margin-bottom:32px">
            ...
            <div>
                <div style="display:flex;align-items:center;gap:9px;margin-bottom:10px">
                    ...
                    <span style="color:#fff;font-weight:700;font-size:15px"><?php echo e($siteName); ?></span>
                </div>
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $footerCats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e($cat->url); ?>"
                   style="display:block;font-size:13px;color:#777;margin-bottom:8px;
                          text-decoration:none;transition:color .15s"
                   onmouseover="this.style.color='#fff'"
                   onmouseout="this.style.color='#777'"><?php echo e($cat->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <a href="<?php echo e(route('catalog')); ?>" style="display:block;font-size:13px;color:#777;margin-bottom:8px;text-decoration:none">Офисные кресла</a>
                <a href="<?php echo e(route('catalog.category','kresla-rukovoditelya')); ?>" style="display:block;font-size:13px;color:#777;margin-bottom:8px;text-decoration:none">Кресла руководителя</a>
                <a href="<?php echo e(route('catalog.category','ergonomichnye-kresla')); ?>" style="display:block;font-size:13px;color:#777;text-decoration:none">Эргономичные кресла</a>
            ...
            <div>
                ...
                <p style="font-size:13px;color:#777;margin-bottom:8px"><?php echo e($address); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div style="border-top:1px solid #222;padding-top:16px;font-size:12px;color:#555">
            © <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. Все права защищены.
        </div>
    </div>
</footer>
...
<?php /**PATH /var/www/vhosts/autohimiki.kz/xn----8sbnbmoilhzgg4a5h.kz/resources/views/components/ui/footer.blade.php ENDPATH**/ ?>
    ...
    <div class="site-footer__inner">
        <div class="site-footer__grid">
            ...
            <div class="site-footer__contacts">
                ...
                <p>{{ $address }}</p>
                <a href="tel:{{ preg_replace('/\D/', '', $phone) }}" class="site-footer__phone" data-analytics-location="footer" data-phone="{{ preg_replace('/\D/', '', $phone) }}">{{ $phone }}</a>
                <a href="https://wa.me/{{ preg_replace('/\D/', '', $whatsapp) }}" target="_blank" rel="noopener" class="site-footer__wa" data-analytics-location="footer">

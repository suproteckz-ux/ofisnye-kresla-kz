...
class KaspiPhotoImporter
{
    ...
    public function import(Product $product, array $photoUrls, bool $dryRun = false): array
    {
        ...
        foreach ($photoUrls as $photoUrl) {
            ...
            $directory = "products/{$product->id}/kaspi";
    ...
    private function download(string $url): array
    {
        ...
        if ($host && $this->isInternalHost($host)) {
            return ['ok' => false, 'error' => 'internal_host_blocked'];
        }

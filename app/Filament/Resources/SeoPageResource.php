...
class SeoPageResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Section::make('Связанные категории')
                ->schema([
            ...
            Section::make('CTA')
                ->columns(2)
                ->schema([
                    TextInput::make('cta_title')->label('Заголовок')->maxLength(255)->nullable()->columnSpanFull(),
                    Textarea::make('cta_text')->label('Текст')->rows(3)->maxLength(1000)->nullable()->columnSpanFull(),
                    TextInput::make('cta_button_text')->label('Текст кнопки')->maxLength(120)->nullable(),
                    TextInput::make('cta_button_url')->label('URL кнопки')->maxLength(500)->nullable(),
                ]),
